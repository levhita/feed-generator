...
[![Deploy to DigitalOcean](https://www.deploytodo.com/do-btn-blue.svg)](https://cloud.digitalocean.com/apps/new?repo=https://github.com/levhita/feed-generator/tree/main)

1. In the first screen you will see a **feed-generator Web Service resource** click edit on it.
1. Edit and Save the **Build Command** so it reads `npm run build:digitalocean`
